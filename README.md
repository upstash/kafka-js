...
The producer has the most to gain from a serverless approach in my opinion. So
right now this is the only thing I implemented. I'll add the other features
soon, but if it's urgent for you, then please open an issue and we can discuss
