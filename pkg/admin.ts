...
export class Admin {
   ...
   */
  public async removeConsumerInstance(consumerGroup: string, instanceId: string): Promise<void> {
   ...
   */
  public async committedOffsets(req: OffsetsRequest): Promise<TopicPartitionOffset[]> {
